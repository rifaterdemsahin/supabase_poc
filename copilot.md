...
2. **Debug Menu** (hidden by default) — All supabase_poc framework links (7 stages, agent files, tools). Only shown when the user clicks the **debug button** at the **bottom-right corner** of the page.
...
**Goal:** Create a template project that can be used by other projects at start — `supabase_poc` v0.9
