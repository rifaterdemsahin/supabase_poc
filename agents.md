...
- **Architecture Documentation Sync** — When the system architecture changes, immediately update the architecture overview document at [`2_Environment/architecture.md`](file:///Users/rifaterdemsahin/projects/supabase_poc/2_Environment/architecture.md) (with updated Mermaid diagrams) to keep it working.
